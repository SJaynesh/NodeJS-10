...
const addCategoryPage = (req, res) => {
    ...
    res.render('category/addCategoryPage', { success: req.flash('success'), error: req.flash('error') });
}
...
const viewCategoryPage = async (req, res) => {
    try {
        ...
        if (record) {
            res.render('category/viewCategoryPage', { records: record, success: req.flash('success'), error: req.flash('error') });
        } else {
...
const deleteCategory = async (req, res) => {
    ...
    try {
        const deleteData = await category.findByIdAndDelete({ _id: req.params.id });
...
const editCategoryPage = async (req, res) => {
    try {
        ...
        if (data) {
            res.render('category/editCategoryPage', { data: data, success: "", error: "" });
        } else {
            res.redirect('back');
        }
    } catch (e) {
